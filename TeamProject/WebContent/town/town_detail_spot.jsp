...
<c:if test="${not empty spot.useSeason }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3" style="font-weight: 700;">이용시기</span>
...
<c:if test="${not empty spot.expGuide }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3" style="font-weight: 700;">체험안내</span>
...
<c:if test="${not empty spot.heritage1 && spot.heritage1 ne '0'}">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3" style="font-weight: 700;">세계 문화유산 유무</span>
		<span class="col-sm-9">${spot.heritage1}</span>
	</li>
</c:if>
<c:if test="${not empty spot.heritage2 && spot.heritage2 ne '0'}">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3" style="font-weight: 700;">세계 자연유산 유무</span>
		<span class="col-sm-9">${spot.heritage2}</span>
	</li>
</c:if>
<c:if test="${not empty spot.heritage3 && spot.heritage3 ne '0'}">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3" style="font-weight: 700;">세계 기록유산 유무</span>
