...
<c:if test="${not empty festival.subevent }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">부대행사:</span>
...
<c:if test="${not empty festival.bookingPlace}">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">예매처:</span>
...
<c:if test="${not empty festival.placeInfo}">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">행사장 위치안내:</span>
