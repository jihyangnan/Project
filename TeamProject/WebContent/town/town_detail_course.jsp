...
<c:if test="${not empty course.distance }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">총 거리:</span>
		<span class="col-sm-9">${course.distance}</span>
	</li>
</c:if>

<c:if test="${not empty course.takeTime }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">총 소요시간:</span>
		<span class="col-sm-9">${course.takeTime}</span>
	</li>
</c:if>

<c:if test="${not empty course.schedule }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">일정:</span>
		<span class="col-sm-9">${course.schedule}</span>
	</li>
</c:if>

<c:if test="${not empty course.theme }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">테마:</span>
