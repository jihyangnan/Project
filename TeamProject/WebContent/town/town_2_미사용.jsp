				...
				<hr style="margin-top: 30px; margin-bottom: 30px; border: 0; border-top: 1px solid #dce0e0;">
					...
					<div class="col-md-5 service_box" style="float: left;">
						<ul style="list-style: none; margin-top: 10px;">
							...
							<input type="submit" value="여기로 놀러가기" style="margin-left: 70%; margin-bottom: 2%;">
							<div>
					...
					<div class="col-md-6 service_box" style="padding-left: 9%;">
						<input type="submit" value="목록 보기" style="margin-left: 90%; ">
						...
						<hr
							...
							<p>대한불교조계종 11교구본사의 하나로 그 경내는 2009년 12월 21일에 사적 제502호로
								지정되었으며 1995년 세계문화유산목록에 등록되었다.</p>
