...
<c:if test="${not empty food.seat }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">좌석수:</span>
...
<c:if test="${not empty food.reservation }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">예약안내:</span>
...
<c:if test="${not empty food.firstmenu }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">대표 메뉴:</span>
		<span class="col-sm-9">${food.firstmenu}</span>
	</li>
</c:if>
<c:if test="${not empty food.treatmenu }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">취급 메뉴:</span>
		<span class="col-sm-9">${food.treatmenu}</span>
	</li>
</c:if>
<c:if test="${not empty food.smoking }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">금연/흡연:</span>
		<span class="col-sm-9">${food.smoking}</span>
	</li>
</c:if>
<c:if test="${not empty food.chkCreditCard }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">신용카드:</span>
		<span class="col-sm-9">${food.chkCreditCard}</span>
	</li>
</c:if>
<c:if test="${not empty food.packing }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">포장:</span>
		<span class="col-sm-9">${food.packing}</span>
	</li>
</c:if>
<c:if test="${not empty food.kidsfacility }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">어린이 놀이방:</span>
		<span class="col-sm-9">${food.kidsfacility}</span>
	</li>
</c:if>
<c:if test="${not empty food.openDate }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">개업일:</span>
