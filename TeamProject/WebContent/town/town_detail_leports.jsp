...
<c:if test="${not empty leports.openPeriod }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">개장기간:</span>
...
<c:if test="${not empty leports.useFee }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">입장료:</span>
...
<c:if test="${not empty leports.chkPet }">
	<li class="row" style="margin-bottom: 10px"><span class="col-sm-3">애완동물 대여 여부:</span>
