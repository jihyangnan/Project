...
<div class="about_top">
	<div class="container">
		...
		<div class="about">
			<br>
			<h1 class="blog_head">아이디/비밀번호 찾기</h1>

			<div class="s_Id_form" style="margin-bottom: 100px">
				<label style="padding: 15px 15px 15px 180px; font-size: 20px">아이디
					찾기</label>
				<div class="form2_s">
					<div class="form3_s">
					...
					<div class="clear"></div>
					<label> <a href="index.jsp?page=join/idCheck.jsp"> <input
			...
			<div class="s_Pwd_form" style="margin-bottom: 100px">
				<label style="padding: 15px 15px 15px 160px; font-size: 20px">비밀번호
					찾기</label>
				<div class="form2_s">
					<div class="form3_s">
					...
					<label> <a href="index.jsp?page=join/pwdCheck.jsp"> <input
							type="button" style="margin-top: 10px" value="확인">
					</a>
					</label>
					<div class="s_form6">
						<label> <a href="index.jsp?page=join/login.jsp"> <input type="submit"
								style="margin-top: 10px" value="로그인">
						</a>
						</label>
					</div>
				</div>
