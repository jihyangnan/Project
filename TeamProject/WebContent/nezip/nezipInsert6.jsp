...
<div style="padding-left: 10px">
	...
	<div class="service_grid"
		style="border: 2px solid #f94b4b; margin-top: 20px; border-radius: 10px;">
	...
	<div class="joinup">
		<a href="nezip_insert5.do"> <input type=button value="이전"
			id="join" class="btn">
		</a> &nbsp;&nbsp;&nbsp; <input type="button" value="완료" id="join"
			class="btn">
	</div>
</div>
